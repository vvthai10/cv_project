...
from lib.utils import tokenize_sentence, truncated_noise, prepare_sample_data
...
def parse_args():
    ...
    parser.add_argument('--sent', dest='sentence', type=str, default='This bird has an orange bill',
                        help='description sentence', required=True)
...
def sample_example(wordtoix, netG, text_encoder, args, save=True):
    ...
    print("Go to tokenize")
    captions, cap_lens, _ = tokenize_sentence(wordtoix, sentence)
